  ...
  <div>
    ...
    <div class="dl-index-mobile-navigation nav">
      <div class="dl-index-mobile-navigation-left col-sm-6">
        <span class="dl-logo-mobile dl-logo-font"> D/L </span>
      </div>

      <div class="col-sm-6 dl-index-mobile-navigation-right">
        <div id="icon" class="icon" @click="activateIcon($event)">
          <span></span>
          <span></span>
          <span></span>
        </div>
    ...
    <nav id="nav_mobile_menu" @keydown="nav($event)">
      <ul id="mobile_menu" class="nav_menu" @click="navMenu()">
        <li class="nav_item" @click="navItem($event)">
          <a class="nav_link" href="#profile">Profile</a>
        </li>
        <li class="nav_item" @click="navItem($event)">
          <a class="nav_link" href="#experiences">Experiences</a>
        </li>
        <li class="nav_item" @click="navItem($event)">
          <a class="nav_link" href="#abilities">Abilities</a>
        </li>
        <li class="nav_item" @click="navItem($event)">
    ...
    hideMenu: function () {
      ...
      window.addEventListener("scroll", function () {
        ...
        if (
          ...
          (nav_item_clicked == "1" && (mobileNav.style.top = ""))
        ) {
